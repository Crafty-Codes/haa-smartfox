...
def setup_platform(
    ...
    add_entities([ToGridDailySolarSensor()])


class ToGridDailySolarSensor(SensorEntity):
    """Representation of a Sensor."""

    _attr_name = "To Grid Solar Sensor Daily"
    ...
    def update(self) -> None:
        ...
        if response.status_code == 200:
            ...
            wr1PowerValueElement = root.find('.//value[@id="eDayToGridValue"]')
            ...
            if wr1PowerValueElement is not None:
                ...
                powerValueText = powerValueText.replace(' Wh', '')
