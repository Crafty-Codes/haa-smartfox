...
def setup_platform(
    ...
    add_entities([FromGridDailySolarSensor()])


class FromGridDailySolarSensor(SensorEntity):
    """Representation of a Sensor."""

    _attr_name = "From Grid Solar Sensor Daily"
    ...
    def update(self) -> None:
        ...
        if response.status_code == 200:
            ...
            wr1PowerValueElement = root.find(
                './/value[@id="hidFromGridEnergyDay"]')
