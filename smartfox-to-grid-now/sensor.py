...
def setup_platform(
    ...
    add_entities([ToGridNowSolarSensor()])


class ToGridNowSolarSensor(SensorEntity):
    """Representation of a Sensor."""

    _attr_name = "To Grid Solar Sensor Now"
    ...
    def update(self) -> None:
        ...
        if response.status_code == 200:
            ...
            wr1PowerValueElement = root.find('.//value[@id="toGridValue"]')
            ...
            if wr1PowerValueElement is not None:
                ...
                powerValueText = powerValueText.replace(' kW', '')
